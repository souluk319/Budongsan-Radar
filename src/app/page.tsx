...
import { MarketPulseVisual } from "@/components/market-pulse-visual";
  ...
  return (
    <>
      ...
      <main className="flex-1 bg-[#f7f5ef]">
        <section className="mx-auto w-full max-w-7xl px-4 pb-7 pt-4 sm:px-6 sm:pb-10 sm:pt-7 lg:px-8">
          <MarketPulseVisual
            model={homeModel}
        ...
        <section className="mx-auto grid w-full max-w-7xl gap-7 px-4 pb-10 sm:px-6 lg:grid-cols-[minmax(0,1fr)_22rem] lg:px-8">
