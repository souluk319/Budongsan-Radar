      ...
      <main className="flex-1 bg-[#eef3f4]">
        <section className="mx-auto w-full max-w-6xl px-4 pb-5 pt-5 sm:px-6 sm:pb-7 sm:pt-8 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-sm font-black text-[#11140f]">운영자</p>
        ...
        <section className="mx-auto grid w-full max-w-6xl gap-6 px-4 py-8 sm:px-6 lg:px-8">
          {!setup.hasSupabaseAdmin ? (
            <div className="max-w-xl rounded-md border border-[#f1d09a] bg-[#f8fbfb] p-4 text-sm font-semibold leading-6 text-[#7a4a0f]">
          ...
          {!auth.user ? (
            <div className="max-w-xl rounded-md border border-[#cbd6d8] bg-white p-5">
              <h3 className="text-base font-black text-[#14110f]">
                운영자 로그인이 필요합니다
              </h3>
              <p className="mt-1 text-sm font-semibold leading-6 text-[#667174]">
                운영 큐는 권한이 있는 계정으로만 볼 수 있습니다.
              </p>
              <Link
                href="/login?next=/admin"
                className="mt-3 inline-flex h-10 items-center rounded-md bg-[#14110f] px-4 text-sm font-black text-white hover:bg-[#2a2d2f]"
              >
                로그인하러 가기
              </Link>
            </div>
          ...
          {auth.user?.isAdmin ? (
            <>
              ...
              <section className="grid gap-3 rounded-md border border-[#cbd6d8] bg-white p-5">
                <div>
                    ...
                    {pending.links.map((link) => (
                      ...
                      >
                        <div className="min-w-0">
                          ...
                          <div className="mt-2 flex flex-wrap gap-2 text-xs font-bold text-[#667174]">
                            <span>
                              근거{" "}
