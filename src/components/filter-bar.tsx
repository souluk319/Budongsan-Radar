...
export function FilterBar({
  ...
  return (
    <section className="grid gap-4 rounded-xl border border-[#cbd3d5] bg-white/70 p-4 shadow-[0_18px_44px_rgba(26,38,42,0.08)] backdrop-blur">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-sm font-medium text-[#596366]">관심 기준</p>
          ...
          <Link
            href="/"
            className="h-8 rounded-full border border-[#cbd3d5] bg-[#f8fbfb] px-3 py-1.5 text-xs font-semibold text-[#4d575a] hover:border-[#11140f] hover:text-[#11140f]"
          >
            전체 보기
          </Link>
        </div>
