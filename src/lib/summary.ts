    ...
    input: [
      {
        role: "system",
        content:
          "너는 한국 부동산 이슈 큐레이션 편집자다. 투자 조언, 매수/매도 추천, 확정적 예측을 금지한다. 사실/해석/불확실성을 분리하고 실수요자 관점으로 짧고 명확하게 쓴다.",
      },
      {
        role: "user",
        content: [
          ...
          "위 이슈를 한국어로 요약해라. 모든 문장은 참고 정보임을 전제로 작성하고, 행동을 지시하지 말고 체크포인트 중심으로 정리해라.",
        ].join("\n"),
      },
    ],
    text: {
